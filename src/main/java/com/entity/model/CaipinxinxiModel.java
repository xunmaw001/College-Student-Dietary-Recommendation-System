...
public class CaipinxinxiModel  implements Serializable {
	...
	public void setCaipinfengmian(String caipinfengmian) {
		this.caipinfengmian = caipinfengmian;
	}
	
	/**
	 * 获取：菜品封面
	 */
	public String getCaipinfengmian() {
		return caipinfengmian;
	}
