	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="班级名称" prop="banjimingcheng">
					<el-input v-model="ruleForm.banjimingcheng" placeholder="班级名称" clearable  :readonly="ro.banjimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="班级名称" prop="banjimingcheng">
